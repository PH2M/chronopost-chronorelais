...
define([
    ...
    return Collection.extend({
        ...
        isDisabled: function (elem) {
            ...
            var name = elem.name;
            if (name === 'chronopost_sales_order_grid.chronopost_sales_order_grid.chronopost_sales_order_columns.length') {
                return true;
            }

            if (name === 'chronopost_sales_order_grid.chronopost_sales_order_grid.chronopost_sales_order_columns.height') {
                return true;
            }

            if (name === 'chronopost_sales_order_grid.chronopost_sales_order_grid.chronopost_sales_order_columns.expiration_date') {
                return true;
            }

            if (name === 'chronopost_sales_order_grid.chronopost_sales_order_grid.chronopost_sales_order_columns.contract') {
                return true;
            }

            if (name === 'chronopost_sales_order_grid.chronopost_sales_order_grid.chronopost_sales_order_columns.width') {
                return true;
            }

            if (name === 'chronopost_sales_order_grid.chronopost_sales_order_grid.chronopost_sales_order_columns.multi_colis') {
                return true;
            }

            if (name === 'chronopost_sales_order_grid.chronopost_sales_order_grid.chronopost_sales_order_columns.weight') {
                return true;
            }
